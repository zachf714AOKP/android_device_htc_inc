...
```bash
wget -O .repo/local_manifest/local_manifest_linaro.xml https://raw.github.com/zachf714AOKP/android_device_htc_inc/cm-10.1/Manifest/linaro_optimizations.xml
```
